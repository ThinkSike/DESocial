...
export default function CreatePost({ onCreatePost }: CreatePostProps) {
  ...
  const canPost = (text.trim().length > 0 || selectedImages.length > 0) && !isPosting;
        ...
        <View style={styles(colors).rightControls}>
          ...
          >
            <Ionicons
              name="image-outline"
              size={20}
              color={selectedImages.length >= 4 ? colors.textSecondary : colors.primary}
            />
          </TouchableOpacity>
        </View>
      </View>
      ...
      <View style={styles(colors).bottomRow}>
        ...
        <TouchableOpacity
          style={[
            ...
            canPost ? styles(colors).postButtonActive : styles(colors).postButtonDisabled
          ]}
          onPress={handlePost}
          disabled={!canPost}
        >
          <Text style={[
            ...
            canPost ? styles(colors).postButtonTextActive : styles(colors).postButtonTextDisabled
          ]}>
